...
const pricingLocales = {
  'pricing.html': {
    meta: 'One-time AI background removal credits for e-commerce sellers. 100 credits ¥22, 300 credits ¥60, or 1000 credits ¥160. Purchased credits never expire.',
    ...
    perImage: ['¥0.22 / image', '¥0.20 / image', '¥0.16 / image'],
  ...
  'de/pricing.html': {
    meta: 'Einmalige KI-Credits für E-Commerce-Produktfotos: 100 Credits für ¥22, 300 für ¥60 oder 1000 für ¥160. Gekaufte Credits verfallen nie.',
    ...
    packNames: ['100 Credits', '300 Credits', '1000 Credits'],
    perImage: ['¥0,22 / Bild', '¥0,20 / Bild', '¥0,16 / Bild'],
  ...
  'es/pricing.html': {
    meta: 'Créditos de IA de compra única para fotos de productos: 100 créditos por ¥22, 300 por ¥60 o 1000 por ¥160. Los créditos comprados no caducan.',
    ...
    perImage: ['¥0,22 / imagen', '¥0,20 / imagen', '¥0,16 / imagen'],
    popular: 'Más popular',
    packFeatures: [
  ...
  'fr/pricing.html': {
    meta: 'Crédits IA à achat unique pour photos produits : 100 crédits à ¥22, 300 à ¥60 ou 1000 à ¥160. Les crédits achetés n’expirent jamais.',
  ...
  'pt-br/pricing.html': {
    meta: 'Créditos de IA de compra única para fotos de produtos: 100 créditos por ¥22, 300 por ¥60 ou 1000 por ¥160. Créditos comprados não expiram.',
    ...
    packNames: ['100 créditos', '300 créditos', '1000 créditos'],
    perImage: ['¥0,22 / imagem', '¥0,20 / imagem', '¥0,16 / imagem'],
...
function renderPricing(locale) {
  const packs = [
    { credits: 100, price: '22', id: 'pp-100' },
    { credits: 300, price: '60', id: 'pp-300', featured: true },
    { credits: 1000, price: '160', id: 'pp-1000' },
  ];
...
for (const [file, locale] of Object.entries(pricingLocales)) {
  ...
  html = html.replace(/currency=USD/g, 'currency=CNY');
  html = html.replace(
...
const indexCopy = {
  'index.html': [
    ...
    ['<p>Upgrade to Starter for just <strong>$4.9/month</strong> and get 200 credits — enough for 200 HD product images every month.</p>', '<p>Buy <strong>100 credits for ¥22</strong> when you need more. Purchased credits never expire and there is no subscription.</p>'],
    ['200 HD credits every month', '100 permanent paid credits'],
    ['Upgrade to Starter — $4.9/mo →', 'Buy 100 credits — ¥22 →'],
  ...
  'de/index.html': [
    ...
    ['<p>Wechsle zu Starter für nur <strong>$4.9/Monat</strong> und erhalte 200 Credits — genug für 200 HD-Produktbilder pro Monat.</p>', '<p>Kaufe bei Bedarf <strong>100 Credits für ¥22</strong>. Gekaufte Credits verfallen nie und es gibt kein Abonnement.</p>'],
    ['200 HD-Credits jeden Monat', '100 dauerhaft gültige Credits'],
    ['Auf Starter upgraden — $4.9/Monat →', '100 Credits kaufen — ¥22 →'],
  ...
  'es/index.html': [
    ...
    ['<p>Pasa a Starter por solo <strong>$4.9/mes</strong> y obtén 200 créditos — suficiente para 200 imágenes HD de productos cada mes.</p>', '<p>Compra <strong>100 créditos por ¥22</strong> cuando los necesites. Los créditos comprados no caducan y no hay suscripción.</p>'],
    ['200 créditos HD cada mes', '100 créditos pagados permanentes'],
    ['Pasar a Starter — $4.9/mes →', 'Comprar 100 créditos — ¥22 →'],
  ...
  'fr/index.html': [
    ...
    ['<p>Passez à Starter pour seulement <strong>$4.9/mois</strong> et obtenez 200 crédits — suffisant pour 200 images HD produits chaque mois.</p>', '<p>Achetez <strong>100 crédits à ¥22</strong> lorsque nécessaire. Les crédits achetés n’expirent jamais et il n’y a aucun abonnement.</p>'],
    ['200 crédits HD chaque mois', '100 crédits payants permanents'],
    ['Passer à Starter — $4.9/mois →', 'Acheter 100 crédits — ¥22 →'],
  ...
  'pt-br/index.html': [
    ...
    ['<p>Faça upgrade para o Starter por apenas <strong>$4.9/mês</strong> e ganhe 200 créditos — o suficiente para 200 imagens HD de produtos por mês.</p>', '<p>Compre <strong>100 créditos por ¥22</strong> quando precisar. Créditos comprados nunca expiram e não há assinatura.</p>'],
    ['200 créditos HD todo mês', '100 créditos pagos permanentes'],
    ['Fazer upgrade para Starter — $4.9/mês →', 'Comprar 100 créditos — ¥22 →'],
